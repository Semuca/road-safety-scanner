...
"")
        ...
        self.addColoumnQueryToolTip = QLabel(self.addColumnPage)
        self.addColoumnQueryToolTip.setObjectName(u"addColoumnQueryToolTip")
        self.addColoumnQueryToolTip.setEnabled(True)
        self.addColoumnQueryToolTip.setGeometry(QRect(120, 130, 461, 16))
        font = QFont()
        font.setFamilies([u"Arial"])
        font.setPointSize(12)
        font.setItalic(True)
        self.addColoumnQueryToolTip.setFont(font)
...
"")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.addColumnQueryText.setPlaceholderText(QCoreApplication.translate("Dialog", u"Example Prompt: Can you say the jounal's relevance to Australia on a scale from 1-10? Say nothing except the rating.", None))
        ...
        self.addColoumnQueryToolTip.setText(QCoreApplication.translate("Dialog", u"At end of prompt, add \"Say nothing except [topic].\"", None))
